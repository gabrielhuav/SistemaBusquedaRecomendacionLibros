...
function llenarSelectTemas() {
    const url = 'http://localhost:8080/Nombre_Personalizado_De_Mi_Proyecto/webresources/Temas';
...
function llenarSelectGustoTemas() {
    ...
    const url = 'http://localhost:8080/Nombre_Personalizado_De_Mi_Proyecto/webresources/Temas/' + id ;
...
function llenarListaRecomendacion(){  
    const url = 'http://localhost:8080/Nombre_Personalizado_De_Mi_Proyecto/webresources/Temas/lista/' + id ;
