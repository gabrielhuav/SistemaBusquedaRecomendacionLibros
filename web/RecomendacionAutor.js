...
function llenarSelect(){
    ...
    const url = 'http://localhost:8080/Proyecto_Libros/webresources/AutorFavorito/' + idUsuario ;
...
function llenarListaRecomendacion(){
    let idUsuario = document.getElementById("idUsuario").value;
    const url = 'http://localhost:8080/Proyecto_Libros/webresources/AutorFavorito/lista/' + idUsuario ;
